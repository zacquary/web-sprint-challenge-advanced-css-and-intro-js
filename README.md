...
1. How would you describe acessibility on the web to someone new to programming? The ability to navigate and work through a website with ease. 
2. Talk about 3 different things you can do to ensure your website is accessible.
semantic tags, alt tags, class and id attributes, use labels on inputs. 
3. How would you explain the concept of a variable to someone new to programming?
a variable is a key assigned to a certain attribute such as a number, string, or boolean.

4. What is the purpose of using functions in code?
functions allow you to iterate through datasets and complete certain tasks that would be required by someone.
